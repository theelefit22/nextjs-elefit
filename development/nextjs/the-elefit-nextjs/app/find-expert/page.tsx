            ...
            <div className="flex-1 px-4 py-8 md:px-8 pb-32">
                <div className="max-w-6xl mx-auto">
                    <div className="mb-12">
                        ...
                        <p className="text-lg text-[#AFAFAF]">Discover certified fitness experts and book your sessions</p>
                    </div>

                    <Card className="p-6 bg-[#0D0D0D] border-[#212121] mb-8">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <input
                                type="text"
                                placeholder="Search experts..."
                                className="rounded-lg bg-black border border-[#212121] px-4 py-2 text-white placeholder-[#666]"
                            />
                            <select className="rounded-lg bg-black border border-[#212121] px-4 py-2 text-white">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {experts.map((expert) => (
                            <Card key={expert.id} className="p-6 bg-[#0D0D0D] border-[#212121] hover:border-primary/50 transition-colors">
